...
List<Dish> menuList = (List<Dish>) session.getAttribute("dishlist");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="card1">
                    <div class="image1">
                        <img src="<%=dish.getImagePath() != null ? dish.getImagePath() : "default-dish.jpg"%>" 
                             alt="Dish Image"
                             onerror="this.src='default-dish.jpg';">
                    </div>
                    <div class="text1">
                        <h3>Special Dish</h3>
                        <h1><%=dish.getName()%></h1>
